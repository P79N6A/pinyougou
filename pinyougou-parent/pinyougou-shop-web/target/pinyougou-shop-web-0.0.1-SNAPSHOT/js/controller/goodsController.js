	...
	$scope.$watch('entity.goods.typeTemplateId',function (newValue, oldValue) {
		typeTemplateService.findOne(newValue).success(
			function (response) {
                ...
                $scope.typeTemplate.brandIds=JSON.parse( $scope.typeTemplate.brandIds);//品牌模板

				if($location.search()['id']==null){//如果为空则是增加
